...
module user_rom #(
  ...
  always_comb begin
    ...
    if (req_q) begin
      if (~we_q) begin
        case(word_addr_q)
          //TODO: Name of "Qiwen and Yizhen" with zero termination
          3'b000: rsp_data= 32'h65776951; // Qiwe
          3'b001: rsp_data= 32'h6E61206E; // n an
          3'b010: rsp_data= 32'h69592064; // d Yi
          3'b011: rsp_data= 32'h6E65687A; // zhen
