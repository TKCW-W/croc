...
// FUNCTIONS
Vtb_user_prng__Syms::~Vtb_user_prng__Syms()
{
#ifdef VM_TRACE
...
void Vtb_user_prng__Syms::_traceDump() {
    const VerilatedLockGuard lock(__Vm_dumperMutex);
    __Vm_dumperp->dump(VL_TIME_Q());
}

void Vtb_user_prng__Syms::_traceDumpOpen() {
    const VerilatedLockGuard lock(__Vm_dumperMutex);
...
void Vtb_user_prng__Syms::_traceDumpClose() {
    const VerilatedLockGuard lock(__Vm_dumperMutex);
    __Vm_dumping = false;
    VL_DO_CLEAR(delete __Vm_dumperp, __Vm_dumperp = nullptr);
}

Vtb_user_prng__Syms::Vtb_user_prng__Syms(VerilatedContext* contextp, const char* namep, Vtb_user_prng* modelp)
