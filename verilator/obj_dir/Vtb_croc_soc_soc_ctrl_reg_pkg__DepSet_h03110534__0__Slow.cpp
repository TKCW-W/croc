...
VL_ATTR_COLD void Vtb_croc_soc_soc_ctrl_reg_pkg___ctor_var_reset(Vtb_croc_soc_soc_ctrl_reg_pkg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_croc_soc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vtb_croc_soc_soc_ctrl_reg_pkg___ctor_var_reset\n"); );
